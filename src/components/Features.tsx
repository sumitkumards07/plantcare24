...
export default function Features() {
  ...
  return (
    <section id="services" className="w-full max-w-[1440px] mx-auto px-4 md:px-12 py-16 md:py-24 relative z-10">
      <motion.div 
      ...
      >
        <h2 className="text-4xl md:text-5xl font-bold text-primary tracking-tight">Why We're Building This</h2>
      </motion.div>
      ...
      >
        {features.map((feature, index) => (
          <motion.div 
            ...
            whileHover={{ y: -5 }}
            className="glass-card rounded-[24px] p-8 flex flex-col items-start transition-all hover:shadow-xl hover:border-white/80"
          >
            <div className="w-16 h-16 rounded-2xl bg-white flex items-center justify-center shadow-sm mb-6 border border-border/50">
              {feature.icon}
            </div>
